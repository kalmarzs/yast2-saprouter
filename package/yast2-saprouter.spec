...
Group:          System/YaST
License:        GPL-2.0
Summary:        SUSE SAPRouter configuration tool
URL:            http://www.suse.com

%description
SUSE SAPRouter configuration tool
...
mkdir -p %{buildroot}%{yast_vardir}/saprouter/
